...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        _sharers = [[NSMutableArray alloc] initWithObjects:
					[[CFSharer alloc] initWithType:CFSharerTypeMail],
					[[CFSharer alloc] initWithType:CFSharerTypeFacebook],
					[[CFSharer alloc] initWithType:CFSharerTypeTwitter],
					[[CFSharer alloc] initWithType:CFSharerTypeKakaoURL],
					[[CFSharer alloc] initWithType:CFSharerTypeKakaoAPP],
					[[CFSharer alloc] initWithType:CFSharerTypeLine],
					nil];
        [self setUpLayers];
    }
    return self;
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if([self circleEnclosesPoint: _currentPosition]) {
        ...
        [self animateOut];
		[[NSNotificationCenter defaultCenter]postNotificationName:@"shareCancel" object:nil];
    }
}
